...
# Form implementation generated from reading ui file 'UI/OrderOtherTelephoneScreen.ui'
#
...
class OrderOtherTelephoneScreen(QtWidgets.QMainWindow):
    def __init__(self, state):
        super(OrderOtherTelephoneScreen, self).__init__()
        self.setupUi()
        self.state = state
    ...
    def retranslateUi(self):
        ...
        self.setWindowTitle(_translate("OrderOtherTelephoneScreen", "OrderOtherTelephoneScreen"))
...
if __name__ == '__main__':
    ...
    ui = OrderOtherTelephoneScreen(state)
    ui.show()
    sys.exit(app.exec_())
